...
const About = () => {
    return (
        <section className="relative z-20 w-full min-h-screen bg-black text-white">
            <div className="py-24 px-8 grid grid-cols-4 gap-x-6 gap-y-6">
                <h2 className="text-8xl font-semibold poppins-medium col-span-4 max-w-[15ch]">
                    Potret Produk Anda
                </h2>
                <div></div>

                <img src="/images/example1.jpg" alt="" />
                <h2 className="text-8xl col-span-2  poppins-medium font-semibold max-w-[10ch]">
                    Dalam Lensa Kami
                </h2>
